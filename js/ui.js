...
import Storage from './storage.js?v=89';
import { NOTIF_TYPES } from './notifications.js?v=89';
import { EXPANSION_REQUIREMENTS } from './data/expansions.js?v=89';
import { t } from './i18n.js?v=89';
import Farm from './farm.js?v=89';
