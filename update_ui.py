...
def main():
    try:
        ...
        new_html = r"""  const bumpkinHtml = bumpkin ? `
  ...
  ` : '';"""
        ...
        # We need to find the old block.
        # It starts with "const bumpkinHtml = bumpkin ? `" and ends with "` : '';"
        
        start_idx = content.find("const bumpkinHtml = bumpkin ? `")
