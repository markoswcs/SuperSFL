...
const SPRING_LAND_5_LAYOUT: () => Layout = () => ({
  id: "spring_5",
  plots: [
    {
      x: -2,
...
const SPRING_LAND_6_LAYOUT: () => Layout = () => ({
  id: "spring_6",
  plots: [],
  fruitPatches: [
    {
...
const SPRING_LAND_7_LAYOUT: () => Layout = () => ({
  id: "spring_7",
  plots: [
    {
      x: -2,
...
const SPRING_LAND_8_LAYOUT: () => Layout = () => ({
  id: "spring_8",
  plots: [
    {
      x: -1,
...
const SPRING_LAND_9_LAYOUT: () => Layout = () => ({
  plots: [],
  fruitPatches: [
    {
      x: -2,
...
const SPRING_LAND_10_LAYOUT: () => Layout = () => ({
  plots: [],
  fruitPatches: [
    {
      x: -2,
...
const SPRING_LAND_11_LAYOUT: () => Layout = () => ({
  plots: [
    {
      x: -2,
      y: 2,
...
const SPRING_LAND_12_LAYOUT: () => Layout = () => ({
  plots: [
    {
      x: -1,
      y: 1,
...
const SPRING_LAND_13_LAYOUT: () => Layout = () => ({
  plots: [],
  fruitPatches: [
    {
      x: -1,
...
const SPRING_LAND_14_LAYOUT: () => Layout = () => ({
  plots: [
    {
      x: -2,
      y: 2,
...
const SPRING_LAND_15_LAYOUT: () => Layout = () => ({
  plots: [
    {
      x: -2,
      y: 2,
...
const SPRING_LAND_16_LAYOUT: () => Layout = () => ({
  plots: [
    {
      x: -2,
      y: 2,
...
const DESERT_LAND_5_LAYOUT: () => Layout = () => ({
  id: "desert_5",
  plots: [{ x: -1, y: 1 }],
  fruitPatches: [],
  gold: [],
...
const DESERT_LAND_6_LAYOUT: () => Layout = () => ({
  id: "desert_6",
  plots: [],
...
const DESERT_LAND_7_LAYOUT: () => Layout = () => ({
  id: "desert_7",
  plots: [
    {
      x: -2,
...
const DESERT_LAND_8_LAYOUT: () => Layout = () => ({
  id: "desert_8",
  plots: [
    {
      x: 0,
...
const DESERT_LAND_9_LAYOUT: () => Layout = () => ({
  id: "desert_9",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const DESERT_LAND_10_LAYOUT: () => Layout = () => ({
  id: "desert_10",
  plots: [
    {
      x: 0,
...
const DESERT_LAND_11_LAYOUT: () => Layout = () => ({
  id: "desert_11",
  plots: [
    {
      x: 1,
...
const DESERT_LAND_12_LAYOUT: () => Layout = () => ({
  id: "desert_12",
  plots: [
    {
      x: -2,
...
const DESERT_LAND_13_LAYOUT: () => Layout = () => ({
  id: "desert_13",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const DESERT_LAND_14_LAYOUT: () => Layout = () => ({
  id: "desert_14",
  plots: [
    {
      x: -2,
...
const DESERT_LAND_15_LAYOUT: () => Layout = () => ({
  id: "desert_15",
  plots: [
    {
      x: -2,
...
const DESERT_LAND_16_LAYOUT: () => Layout = () => ({
  id: "desert_16",
  plots: [
    {
      x: -2,
...
const DESERT_LAND_17_LAYOUT: () => Layout = () => ({
  id: "desert_17",
  plots: [
    {
      x: 0,
...
const DESERT_LAND_18_LAYOUT: () => Layout = () => ({
  id: "desert_18",
  plots: [
    {
      x: 0,
...
const DESERT_LAND_19_LAYOUT: () => Layout = () => ({
  id: "desert_19",
  plots: [
    {
      x: 2,
...
const DESERT_LAND_20_LAYOUT: () => Layout = () => ({
  id: "desert_20",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const DESERT_LAND_21_LAYOUT: () => Layout = () => ({
  id: "desert_21",
  plots: [
    {
      x: -2,
...
const DESERT_LAND_22_LAYOUT: () => Layout = () => ({
  id: "desert_22",
  plots: [],
  fruitPatches: [
    {
...
const DESERT_LAND_23_LAYOUT: () => Layout = () => ({
  id: "desert_23",
  plots: [
    {
      x: -2,
...
const DESERT_LAND_24_LAYOUT: () => Layout = () => ({
  id: "desert_24",
  plots: [
    {
      x: -1,
...
const DESERT_LAND_25_LAYOUT: () => Layout = () => ({
  id: "desert_25",
  plots: [
    {
      x: -1,
...
const DESERT_LAYOUTS: () => Record<number, Layout> = () => ({
...
const VOLCANO_LAND_6_LAYOUT: () => Layout = () => ({
  id: "volcano_6",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_7_LAYOUT: () => Layout = () => ({
  id: "volcano_7",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_8_LAYOUT: () => Layout = () => ({
  id: "volcano_8",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_9_LAYOUT: () => Layout = () => ({
  id: "volcano_9",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_10_LAYOUT: () => Layout = () => ({
  id: "volcano_10",
  plots: [],
  fruitPatches: [],
  gold: [
...
const VOLCANO_LAND_11_LAYOUT: () => Layout = () => ({
  id: "volcano_11",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_12_LAYOUT: () => Layout = () => ({
  id: "volcano_12",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_13_LAYOUT: () => Layout = () => ({
  id: "volcano_13",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_14_LAYOUT: () => Layout = () => ({
  id: "volcano_14",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_15_LAYOUT: () => Layout = () => ({
  id: "volcano_15",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_16_LAYOUT: () => Layout = () => ({
  id: "volcano_16",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_17_LAYOUT: () => Layout = () => ({
  id: "volcano_17",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_18_LAYOUT: () => Layout = () => ({
  id: "volcano_18",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_19_LAYOUT: () => Layout = () => ({
  id: "volcano_19",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_20_LAYOUT: () => Layout = () => ({
  id: "volcano_20",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_21_LAYOUT: () => Layout = () => ({
  id: "volcano_21",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_22_LAYOUT: () => Layout = () => ({
  id: "volcano_22",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_23_LAYOUT: () => Layout = () => ({
  id: "volcano_23",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_24_LAYOUT: () => Layout = () => ({
  id: "volcano_24",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_25_LAYOUT: () => Layout = () => ({
  id: "volcano_25",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_26_LAYOUT: () => Layout = () => ({
  id: "volcano_26",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_27_LAYOUT: () => Layout = () => ({
  id: "volcano_27",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_28_LAYOUT: () => Layout = () => ({
  id: "volcano_28",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_29_LAYOUT: () => Layout = () => ({
  id: "volcano_29",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAND_30_LAYOUT: () => Layout = () => ({
  id: "volcano_30",
  plots: [],
  fruitPatches: [],
  gold: [],
...
const VOLCANO_LAYOUTS: () => Record<number, Layout> = () => ({
...
const LAYOUT_FIELD_TO_NODE = {
  ...
  lavaPits: "Lava Pit",
}  satisfies Partial<Record<keyof Layout, keyof Nodes>>;
...
const TOTAL_EXPANSION_NODES: ExpansionNode = {
...
const SPRING_LAND_5_REQUIREMENTS = {
  resources: {
    Wood: 20,
  },
  coins: 100,
...
const SPRING_LAND_6_REQUIREMENTS = {
  resources: {
    Wood: 10,
    Stone: 5,
    Gold: 2,
...
const SPRING_LAND_7_REQUIREMENTS = {
  resources: {
    Wood: 30,
    Stone: 20,
    Iron: 5,
...
const SPRING_LAND_8_REQUIREMENTS = {
  resources: {
    Wood: 20,
    Crimstone: 1,
    Gem: 1 * LAND_GEM_RATIO,
...
const SPRING_LAND_9_REQUIREMENTS = {
  resources: {
    Wood: 50,
    Gold: 5,
    Gem: 1 * LAND_GEM_RATIO,
...
const SPRING_LAND_10_REQUIREMENTS = {
  resources: {
    Stone: 10,
    Crimstone: 3,
    Gem: 1 * LAND_GEM_RATIO,
...
const SPRING_LAND_11_REQUIREMENTS = {
  resources: {
    Wood: 100,
    Stone: 25,
    Gold: 5,
...
const SPRING_LAND_12_REQUIREMENTS = {
  resources: {
    Wood: 50,
    Iron: 5,
    Crimstone: 3,
...
const SPRING_LAND_13_REQUIREMENTS = {
  resources: {
    Wood: 50,
    Stone: 25,
    Iron: 10,
...
const SPRING_LAND_14_REQUIREMENTS = {
  resources: {
    Wood: 100,
    Stone: 10,
    Crimstone: 5,
...
const SPRING_LAND_15_REQUIREMENTS = {
  resources: {
    Wood: 150,
    Stone: 10,
    Iron: 10,
...
const SPRING_LAND_16_REQUIREMENTS = {
  resources: {
    Wood: 100,
    Stone: 10,
    Gold: 5,
...
const SPRING_LAND_17_REQUIREMENTS = {
  resources: {
    Wood: 100,
    Stone: 20,
    Iron: 10,
...
const SPRING_LAND_18_REQUIREMENTS = {
  resources: {
    Wood: 150,
    Stone: 20,
    Iron: 10,
...
const SPRING_LAND_19_REQUIREMENTS = {
  resources: {
    Wood: 150,
    Stone: 10,
    Iron: 5,
...
const SPRING_LAND_20_REQUIREMENTS = {
  resources: {
    Wood: 50,
    Stone: 5,
    Iron: 5,
...
const DESERT_LAND_5_REQUIREMENTS = {
  resources: {
    Wood: 50,
    Stone: 10,
    Iron: 5,
...
const DESERT_LAND_6_REQUIREMENTS = {
  resources: {
    Wood: 100,
    Stone: 20,
    Iron: 10,
...
const DESERT_LAND_7_REQUIREMENTS = {
  resources: {
    Wood: 150,
    Stone: 20,
    Iron: 10,
...
const DESERT_LAND_8_REQUIREMENTS = {
  resources: {
    Wood: 150,
    Stone: 10,
    Iron: 5,
...
const DESERT_LAND_9_REQUIREMENTS = {
  resources: {
    Wood: 50,
    Stone: 5,
    Iron: 5,
...
const DESERT_LAND_10_REQUIREMENTS = {
  resources: {
    Wood: 100,
    Stone: 50,
    Iron: 10,
...
const DESERT_LAND_11_REQUIREMENTS = {
  resources: {
    Wood: 150,
    Stone: 75,
    Iron: 10,
...
const DESERT_LAND_12_REQUIREMENTS = {
  resources: {
    Wood: 100,
    Stone: 100,
    Iron: 5,
...
const DESERT_LAND_13_REQUIREMENTS = {
  resources: {
    Wood: 200,
    Stone: 50,
    Iron: 15,
...
const DESERT_LAND_14_REQUIREMENTS = {
  resources: {
    Wood: 200,
    Stone: 100,
    Iron: 15,
...
const DESERT_LAND_15_REQUIREMENTS = {
  resources: {
    Wood: 300,
    Stone: 50,
    Iron: 20,
...
const DESERT_LAND_16_REQUIREMENTS = {
  resources: {
    Wood: 250,
    Stone: 125,
    Iron: 15,
...
const DESERT_LAND_17_REQUIREMENTS = {
  resources: {
    Wood: 350,
    Stone: 75,
    Iron: 20,
...
const DESERT_LAND_18_REQUIREMENTS = {
  resources: {
    Wood: 400,
    Stone: 125,
    Iron: 25,
...
const DESERT_LAND_19_REQUIREMENTS = {
  resources: {
    Wood: 450,
    Stone: 150,
    Iron: 30,
...
const DESERT_LAND_20_REQUIREMENTS = {
  resources: {
    Wood: 525,
    Stone: 200,
    Iron: 35,
...
const DESERT_LAND_21_REQUIREMENTS = {
  resources: {
    Wood: 550,
    Stone: 150,
    Iron: 30,
...
const DESERT_LAND_22_REQUIREMENTS = {
  resources: {
    Wood: 600,
    Stone: 200,
    Iron: 35,
...
const DESERT_LAND_23_REQUIREMENTS = {
  resources: {
    Wood: 650,
    Stone: 250,
    Iron: 40,
...
const DESERT_LAND_24_REQUIREMENTS = {
  resources: {
    Wood: 700,
    Stone: 300,
    Iron: 50,
...
const DESERT_LAND_25_REQUIREMENTS = {
  resources: {
    Wood: 750,
    Stone: 350,
    Iron: 50,
...
const VOLCANO_LAND_6_REQUIREMENTS = {
  resources: {
    Wood: 100,
    Stone: 50,
    Iron: 30,
...
const VOLCANO_LAND_7_REQUIREMENTS = {
  resources: {
    Wood: 200,
    Stone: 75,
    Iron: 25,
...
const VOLCANO_LAND_8_REQUIREMENTS = {
  resources: {
    Wood: 300,
    Stone: 100,
    Iron: 40,
...
const VOLCANO_LAND_9_REQUIREMENTS = {
  resources: {
    Wood: 400,
    Stone: 150,
    Iron: 35,
...
const VOLCANO_LAND_10_REQUIREMENTS = {
  resources: {
    Wood: 450,
    Stone: 200,
    Iron: 30,
...
const VOLCANO_LAND_11_REQUIREMENTS = {
  resources: {
    Wood: 500,
    Stone: 175,
    Iron: 30,
...
const VOLCANO_LAND_12_REQUIREMENTS = {
  resources: {
    Wood: 650,
    Stone: 225,
    Iron: 25,
...
const VOLCANO_LAND_13_REQUIREMENTS = {
  resources: {
    Wood: 550,
    Stone: 200,
    Iron: 40,
...
const VOLCANO_LAND_14_REQUIREMENTS = {
  resources: {
    Wood: 700,
    Stone: 250,
    Iron: 35,
...
const VOLCANO_LAND_15_REQUIREMENTS = {
  resources: {
    Wood: 650,
    Stone: 200,
    Iron: 30,
...
const VOLCANO_LAND_16_REQUIREMENTS = {
  resources: {
    Wood: 750,
    Stone: 250,
    Iron: 40,
...
const VOLCANO_LAND_17_REQUIREMENTS = {
  resources: {
    Wood: 700,
    Stone: 200,
    Iron: 35,
...
const VOLCANO_LAND_18_REQUIREMENTS = {
  resources: {
    Wood: 800,
    Stone: 300,
    Iron: 45,
...
const VOLCANO_LAND_19_REQUIREMENTS = {
  resources: {
    Wood: 750,
    Stone: 250,
    Iron: 40,
...
const VOLCANO_LAND_20_REQUIREMENTS = {
  resources: {
    Wood: 850,
    Stone: 300,
    Iron: 45,
...
const VOLCANO_LAND_21_REQUIREMENTS = {
  resources: {
    Wood: 900,
    Stone: 325,
    Iron: 50,
...
const VOLCANO_LAND_22_REQUIREMENTS = {
  resources: {
    Wood: 800,
    Stone: 300,
    Iron: 45,
...
const VOLCANO_LAND_23_REQUIREMENTS = {
  resources: {
    Wood: 950,
    Stone: 350,
    Iron: 50,
...
const VOLCANO_LAND_24_REQUIREMENTS = {
  resources: {
    Wood: 1000,
    Stone: 400,
    Iron: 55,
...
const VOLCANO_LAND_25_REQUIREMENTS = {
  resources: {
    Wood: 1100,
    Stone: 450,
    Iron: 60,
...
const VOLCANO_LAND_26_REQUIREMENTS = {
  resources: {
    Wood: 1200,
    Stone: 350,
    Iron: 65,
...
const VOLCANO_LAND_27_REQUIREMENTS = {
  resources: {
    Wood: 1250,
    Stone: 450,
    Iron: 70,
...
const VOLCANO_LAND_28_REQUIREMENTS = {
  resources: {
    Wood: 1150,
    Stone: 500,
    Iron: 60,
...
const VOLCANO_LAND_29_REQUIREMENTS = {
  resources: {
    Wood: 1350,
    Stone: 550,
    Iron: 65,
...
const VOLCANO_LAND_30_REQUIREMENTS = {
  resources: {
    Wood: 1500,
    Stone: 600,
    Iron: 70,
...
const EXPANSION_REQUIREMENTS: Record<
  BasicIslandType,
 ...
 */
const getExpansionRequirements = ({
  island,
  expansion,
  ascensionLevel,
}: {
...
module.exports = { EXPANSION_REQUIREMENTS };